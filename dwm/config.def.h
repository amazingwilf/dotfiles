...
static const char *fonts[]	= { "DWM Layout Glyphs:size=13",
								"Inter Regular:size=12" };

static const char col_gray1[]	= "#000000";
static const char col_gray2[]	= "#50505B";
static const char col_gray3[]	= "#ABB2BF";
static const char col_gray4[]	= "#DCDCDC";
static const char col_yellow[]	= "#A2CD83";
static const char col_blue[]	= "#62AEEF";
static const char col_magenta[]	= "#C778DD";
static const char col_cyan[]	= "#0000B0";
static const char *colors[][3]	= {
	/*               fg         bg         border   */
	[SchemeNorm]	= { col_gray3,	col_gray1,	col_gray2 },
	[SchemeSel]		= { col_gray4,	col_cyan,	col_blue },
	[SchemeFloat]	= { NULL,		NULL,		col_magenta },
